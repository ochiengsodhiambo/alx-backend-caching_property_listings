...
SECRET_KEY = 'django-insecure-=pwg(30&e_p%($5&gvg0r4_1)%_@o1&3hypu24y4^o2p3acel_'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://redis:6379/1",  # 'redis' matches the service name in docker-compose.yml
        "OPTIONS": {
